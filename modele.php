            ...
            <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
                <div class="col-10 col-sm-8 col-lg-6">
                    <div class="d-flex justify-content-center">
                        <img src="afro-americain-en-costume-tenant-des-documents-et-parlant-a-la-patronne.jpg" class="img-fluid" alt="Bootstrap Themes" width="700" height="500" loading="lazy">
                    </div>
                </div>
                <div class="col-lg-6">
